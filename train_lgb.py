...
features = ['aid', 'objective', 'bid_type', 'advertiser', 'good_id', 'good_type', 'ad_type_id',
            ...
            'aid_kfold_rate', 'advertiser_history_rate', 'aid_2_rate', 'good_id_2_rate', 'advertiser_2_rate',
            'aid_3_rate',
            'good_id_3_rate', 'advertiser_3_rate', 'aid_4_rate', 'good_id_4_rate', 'advertiser_4_rate',

            'aid_aid_rate_kfold_mean_imps', 'aid_aid_rate_kfold_median_imps', 'aid_goods_id_rate_kfold_mean_imps',
            'aid_goods_id_rate_kfold_median_imps', 'aid_account_id_rate_kfold_mean_imps',
            'aid_account_id_rate_kfold_median_imps', 'aid_aid_cnts_kfold_mean', 'aid_aid_cnts_kfold_median',
            'aid_goods_id_cnts_kfold_mean', 'aid_goods_id_cnts_kfold_median', 'aid_account_id_cnts_kfold_mean',
            'aid_account_id_cnts_kfold_median', 'aid_aid_sums_kfold_mean', 'aid_aid_sums_kfold_median',
            'aid_aid_sums_kfold_mean_negs', 'aid_aid_sums_kfold_median_negs', 'aid_goods_id_sums_kfold_mean',
            'aid_goods_id_sums_kfold_median', 'aid_goods_id_sums_kfold_mean_negs',
            'aid_goods_id_sums_kfold_median_negs', 'aid_account_id_sums_kfold_mean', 'aid_account_id_sums_kfold_median',
            'aid_account_id_sums_kfold_mean_negs', 'aid_account_id_sums_kfold_median_negs', 'aid_aid_negs_kfold_mean',
            'aid_aid_negs_kfold_median', 'aid_aid_negs_kfold_mean_sums', 'aid_aid_negs_kfold_median_sums',
            'aid_goods_id_negs_kfold_mean', 'aid_goods_id_negs_kfold_median', 'aid_goods_id_negs_kfold_mean_sums',
            'aid_goods_id_negs_kfold_median_sums', 'aid_account_id_negs_kfold_mean', 'aid_account_id_negs_kfold_median',
            'aid_account_id_negs_kfold_mean_sums', 'aid_account_id_negs_kfold_median_sums',
            ...
            'goods_id_goods_id_cnts_kfold_median', 'goods_id_account_id_cnts_kfold_mean',
            'goods_id_account_id_cnts_kfold_median',
            'goods_id_aid_sums_kfold_mean', 'goods_id_aid_sums_kfold_median', 'goods_id_aid_sums_kfold_mean_negs',
            'goods_id_aid_sums_kfold_median_negs', 'goods_id_goods_id_sums_kfold_mean',
            'goods_id_goods_id_sums_kfold_median',
            ...
            'goods_id_aid_negs_kfold_median_sums', 'goods_id_goods_id_negs_kfold_mean',
            'goods_id_goods_id_negs_kfold_median',
            ...
            'account_id_aid_cnts_kfold_mean', 'account_id_aid_cnts_kfold_median', 'account_id_goods_id_cnts_kfold_mean',
            'account_id_goods_id_cnts_kfold_median', 'account_id_account_id_cnts_kfold_mean',
            'account_id_account_id_cnts_kfold_median', 'account_id_aid_sums_kfold_mean',
            'account_id_aid_sums_kfold_median', 'account_id_aid_sums_kfold_mean_negs',
            'account_id_aid_sums_kfold_median_negs', 'account_id_goods_id_sums_kfold_mean',
            'account_id_goods_id_sums_kfold_median', 'account_id_goods_id_sums_kfold_mean_negs',
            'account_id_goods_id_sums_kfold_median_negs', 'account_id_account_id_sums_kfold_mean',
            'account_id_account_id_sums_kfold_median', 'account_id_account_id_sums_kfold_mean_negs',
            'account_id_account_id_sums_kfold_median_negs', 'account_id_aid_negs_kfold_mean',
            'account_id_aid_negs_kfold_median', 'account_id_aid_negs_kfold_mean_sums',
            'account_id_aid_negs_kfold_median_sums', 'account_id_goods_id_negs_kfold_mean',
            'account_id_goods_id_negs_kfold_median', 'account_id_goods_id_negs_kfold_mean_sums',
            'account_id_goods_id_negs_kfold_median_sums', 'account_id_account_id_negs_kfold_mean',
            'account_id_account_id_negs_kfold_median', 'account_id_account_id_negs_kfold_mean_sums',
            'account_id_account_id_negs_kfold_median_sums', 'industry_id_aid_rate_kfold_mean_imps',
            'industry_id_aid_rate_kfold_median_imps', 'industry_id_goods_id_rate_kfold_mean_imps',
            'industry_id_goods_id_rate_kfold_median_imps', 'industry_id_account_id_rate_kfold_mean_imps',
            'industry_id_account_id_rate_kfold_median_imps', 'industry_id_aid_cnts_kfold_mean',
            'industry_id_aid_cnts_kfold_median', 'industry_id_goods_id_cnts_kfold_mean',
            ...
            'industry_id_aid_sums_kfold_median', 'industry_id_aid_sums_kfold_mean_negs',
            'industry_id_aid_sums_kfold_median_negs', 'industry_id_goods_id_sums_kfold_mean',
            'industry_id_goods_id_sums_kfold_median', 'industry_id_goods_id_sums_kfold_mean_negs',
            'industry_id_goods_id_sums_kfold_median_negs', 'industry_id_account_id_sums_kfold_mean',
            'industry_id_account_id_sums_kfold_median', 'industry_id_account_id_sums_kfold_mean_negs',
            'industry_id_account_id_sums_kfold_median_negs', 'industry_id_aid_negs_kfold_mean',
            'industry_id_aid_negs_kfold_median', 'industry_id_aid_negs_kfold_mean_sums',
            'industry_id_aid_negs_kfold_median_sums', 'industry_id_goods_id_negs_kfold_mean',
            'industry_id_goods_id_negs_kfold_median', 'industry_id_goods_id_negs_kfold_mean_sums',
            'industry_id_goods_id_negs_kfold_median_sums', 'industry_id_account_id_negs_kfold_mean',
            'industry_id_account_id_negs_kfold_median', 'industry_id_account_id_negs_kfold_mean_sums',
            'industry_id_account_id_negs_kfold_median_sums', 'aid_size_aid_rate_kfold_mean_imps',
            'aid_size_aid_rate_kfold_median_imps', 'aid_size_goods_id_rate_kfold_mean_imps',
            'aid_size_goods_id_rate_kfold_median_imps', 'aid_size_account_id_rate_kfold_mean_imps',
            'aid_size_account_id_rate_kfold_median_imps', 'aid_size_aid_cnts_kfold_mean',
            'aid_size_aid_cnts_kfold_median', 'aid_size_goods_id_cnts_kfold_mean',
            'aid_size_goods_id_cnts_kfold_median', 'aid_size_account_id_cnts_kfold_mean',
            'aid_size_account_id_cnts_kfold_median', 'aid_size_aid_sums_kfold_mean', 'aid_size_aid_sums_kfold_median',
            'aid_size_aid_sums_kfold_mean_negs', 'aid_size_aid_sums_kfold_median_negs',
            'aid_size_goods_id_sums_kfold_mean', 'aid_size_goods_id_sums_kfold_median',
            'aid_size_goods_id_sums_kfold_mean_negs', 'aid_size_goods_id_sums_kfold_median_negs',
            'aid_size_account_id_sums_kfold_mean', 'aid_size_account_id_sums_kfold_median',
            'aid_size_account_id_sums_kfold_mean_negs', 'aid_size_account_id_sums_kfold_median_negs',
            'aid_size_aid_negs_kfold_mean', 'aid_size_aid_negs_kfold_median', 'aid_size_aid_negs_kfold_mean_sums',
            ...
            'aid_size_goods_id_negs_kfold_median_sums', 'aid_size_account_id_negs_kfold_mean',
            'aid_size_account_id_negs_kfold_median', 'aid_size_account_id_negs_kfold_mean_sums',
...
best_score = 9999
model = lgb_model.fit(train_x, train_dev['imp'], eval_set=[(test_x, dev['imp'])], early_stopping_rounds=10000,
